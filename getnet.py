...
# model1=load_model('/home/td/PycharmProjects/eyes/csymodels/20200323_182434/sequential_006_kappa-0.86242.h5')
# model2=load_model('/home/td/PycharmProjects/eyes/classify_models/20200323_214509/sequential_017_kappa-0.85666.h5')
# model3=load_model('/home/td/PycharmProjects/eyes/csymodels/20200316_145612/sequential_027_kappa-0.87212.h5')
# model4=load_model('/home/td/PycharmProjects/eyes/classify_models/20200317_232227/sequential_022_kappa-0.86550.h5')
# model5=load_model('/home/td/PycharmProjects/eyes/csymodels/20200316_145612/sequential_013_kappa-0.86358.h5')
# model6=load_model('/home/td/PycharmProjects/eyes/classify_models/20200317_232227/sequential_016_kappa-0.85637.h5')
# model7=tf.keras.models.load_model('/home/td/PycharmProjects/isbi/models/20200318_114015/myInpResNetV2_029_kappa_tta-0.86160.h5', custom_objects=None, compile=False)
# model8=tf.keras.models.load_model('/home/td/PycharmProjects/isbi/models-classify/20200321_185010-tta-classify/myInpResNetV2_classify_008_kappa-tta-0.85551.h5', custom_objects=None, compile=False)
...
def new_csv(r_path, w_path):
    ...
    for filepath in filepaths:
        ...
        for filename in filenames:
            ...
            # y_pre5 = tta(img, model5)
            # y_pre6 = tta(img, model6)
            y_pre3 = tta_classify(img, model3)
            y_pre4 = tta_classify(img, model4)
            # y_pre8=tta_classify(img,model8)
            # y_pre=y_pre1*0.125+y_pre2*0.125+y_pre3*0.125+y_pre4*0.125+y_pre5*0.125+y_pre6*0.125+y_pre7*0.125+y_pre8*0.125
            y_pre = y_pre1 * 0.25 + y_pre2* 0.25 + y_pre3 * 0.25 + y_pre4 * 0.25
...
print(10)
new_csv("/home/td/PycharmProjects/isbi/data/test","Challenge1_upload4.0.csv")
