...
y_train1 = np.concatenate((y_train1,y_train2,wei_labels))
x_train = np.concatenate((x_train1, x_train2,wei_train))


y_train = to_categorical(np.array(y_train1))
y_validation = to_categorical(np.array(y_validation1))


wts = class_weight.compute_class_weight('balanced', np.unique(y_train1),
                                        y_train1)
...
model_dir = os.path.join('.', 'classify_models', st)
